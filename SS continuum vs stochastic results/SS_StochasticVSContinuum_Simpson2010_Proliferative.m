...
a=ones(1,length(x));
for i=1:length(a)
    if i<=find(x==200)-21/dx || i>=find(x==200)+21/dx
        a(i)=0;
    end
end
...
[Chain_out2,Chain02,Chain5002,Chain10002,Chain20002,Cells_index_vect,WaveSpeed,Density_history,c2,C2,WaveSpeed_vect] = SS_Stochastic_Function_Proliferative(CellCycles,alpha,v,Chain,tau);
...
hold on
%Stochastic
plot(0:401/(length(g02)):400,g02,'blue','LineWidth',1)
hold on
plot(0:401/(length(g10002)):400,g10002,'blue','LineWidth',1)
hold on
plot(0:401/(length(g20002)):400,g20002,'blue','LineWidth',1)
hold on
plot(0:401/(length(gfinal2)):400,gfinal2,'blue','LineWidth',1)
xlabel('x')
ylabel('Cell density')
